from api.work.inputs import TaskListInput, InitiativeListInput, StackListInput
...
from api.work.utils import get_tasks, get_tasks_by_product
...
class ProductQuery(ObjectType):
    ...
    products = graphene.List(ProductType, stack_filter=StackListInput(required=False))
